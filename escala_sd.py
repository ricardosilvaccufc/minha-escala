...
# 1. Entrada da Data de Referência INICIALMENTE EM BRANCO
...
# Só executa a lógica se a data de referência for preenchida
if data_ref:
    if opcao == "Data Específica":
        data_alvo = st.date_input(
            ...
            value=None, 
            format="DD/MM/YYYY",
            placeholder="Selecione o dia que deseja consultar"
        )
        if data_alvo:
    ...
    st.warning("Aguardando a seleção da data de referência para gerar a escala.")
